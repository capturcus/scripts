...
sudo apt-get install zsh git build-essential software-properties-common vim-gtk compton alsa-utils pulseaudio xinit software-properties-common i3 iridium-browser rxvt-unicode -y
...
[Service]
ExecStart=
ExecStart=-/sbin/agetty --noissue --autologin dzastin %I $TERM
Type=idle
EOT
